...
namespace DAL.Repositories
{
    internal class ShoppingCartRepository : BaseRepository<ShoppingCart>, IShoppingCartRepository
    {
        ...
        {
            var sql = "SELECT SUM(qty) AS Value FROM currentProductBalance where currentProductBalance.ProductId=productid";
        ...
        {
            string sql = "INSERT INTO currentProductBalance (ProductId, Qty,StoreId,b_order_done,b_order_Pending) VALUES (@p0, @p1,1,0,0)";
