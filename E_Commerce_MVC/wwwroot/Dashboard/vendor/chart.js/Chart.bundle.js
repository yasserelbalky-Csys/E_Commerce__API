 ...
 */
        var exports$1 = {
            ...
            _isPointInArea: function(point, area) {
                ...
                return point.x > area.left - epsilon &&
        ...
        var helpers_options = {
            ...
            _parseFont: function(options) {
                ...
                var font = {
                    ...
                    lineHeight: helpers_core.options.toLineHeight(valueOrDefault(options.lineHeight,
 ...
 */
        ...
        var core_animations = {
            ...
            cancelAnimation: function(chart) {
                var index = helpers$1.findIndex(this.animations,
                    function(animation) {
                ...
                Object.defineProperty(array,
                    key,
                    {
                        ...
                        value: function() {
                            ...
                            helpers$1.each(array._chartjs.listeners,
                                function(object) {
        ...
        helpers$1.extend(DatasetController.prototype,
            {
                ...
                setHoverStyle: function(element) {
                    ...
                    model.backgroundColor =
                        resolve([
                                custom.hoverBackgroundColor, dataset.hoverBackgroundColor,
                                getHoverColor(model.backgroundColor)
                            ],
                            undefined,
                            index);
                    model.borderColor =
                        resolve([custom.hoverBorderColor, dataset.hoverBorderColor, getHoverColor(model.borderColor)],
                            undefined,
                            index);
                    model.borderWidth = resolve([custom.hoverBorderWidth, dataset.hoverBorderWidth, model.borderWidth],
                        undefined,
                        index);
                },
 ...
 */
        ...
        var controller_bar = core_datasetController.extend({
            ...
            calculateBarValuePixels: function(datasetIndex, index, options) {
                ...
                var length = value.start === undefined
                    ? value.end
                ...
                if (stacked || (stacked === undefined && stack !== undefined)) {
                    for (i = 0; i < ilen; ++i) {
                        ...
                        if (imeta.stack === stack) {
                            ...
                            ivalue = stackLength.start === undefined
                                ? stackLength.end
        ...
        var controller_doughnut = core_datasetController.extend({
            ...
            update: function(reset) {
                ...
                if (circumference < DOUBLE_PI$1) {
                    ...
                    var contains90 = (startAngle <= HALF_PI$1 && endAngle >= HALF_PI$1) ||
                        endAngle >= DOUBLE_PI$1 + HALF_PI$1;
                    var contains180 = startAngle === -PI$1 || endAngle >= PI$1;
                    var contains270 = (startAngle <= -HALF_PI$1 && endAngle >= -HALF_PI$1) ||
            ...
            updateElement: function(arc, index, reset) {
                ...
                var dataset = me.getDataset();
                var circumference = reset && animationOpts.animateRotate
                    ? 0
                    : arc.hidden
                    ? 0
            ...
            setHoverStyle: function(arc) {
                ...
                model.backgroundColor =
                    valueOrDefault$5(options.hoverBackgroundColor, getHoverColor(options.backgroundColor));
        ...
        var controller_line = core_datasetController.extend({
            ...
            _resolveDatasetElementOptions: function(element) {
                ...
                values.clip =
                    toClip(valueOrDefault$6(config.clip, defaultClip(me._xScale, me._yScale, values.borderWidth)));
        ...
        var controller_polarArea = core_datasetController.extend({
            ...
            _updateRadius: function() {
                ...
                chart.innerRadius =
                    Math.max(opts.cutoutPercentage ? (chart.outerRadius / 100) * (opts.cutoutPercentage) : 1, 0);
            ...
            setHoverStyle: function(arc) {
                ...
                model.backgroundColor =
                    valueOrDefault(options.hoverBackgroundColor, getHoverColor(options.backgroundColor));
...
// It is this service's responsibility of carrying out that layout.
        var core_layouts = {
            ...
            update: function(chart, width, height) {
                ...
                helpers$1.each(boxes.chartArea,
                    function(layout) {
                        var box = layout.box;
                ...
                for (i = 0, ilen = body.length; i < ilen; ++i) {
                    ...
                    for (j = 0, jlen = lines.length; j < jlen; ++j) {
                        ...
                        if (drawColorBoxes) {
                            ...
                            ctx.fillRect(rtlHelper.leftForLtr(rtlColorX, bodyFontSize),
                                pt.y,
                                bodyFontSize,
                                bodyFontSize);
                            ...
                            ctx.strokeRect(rtlHelper.leftForLtr(rtlColorX, bodyFontSize),
                                pt.y,
                                bodyFontSize,
                                bodyFontSize);
                            ...
                            ctx.fillRect(rtlHelper.leftForLtr(rtlHelper.xPlus(rtlColorX, 1), bodyFontSize - 2),
                                pt.y + 1,
                                bodyFontSize - 2,
                                bodyFontSize - 2);
                            ctx.fillStyle = textColor;
 ...
 */
        function mergeScaleConfig(/* config objects ... */) {
            return helpers$1.merge(Object.create(null),
        ...
        helpers$1.extend(Chart.prototype, /** @lends Chart */
            {
                ...
                */
                ...
                bindEvents: function() {
                    ...
                    helpers$1.each(me.options.events,
                        function(type) {
 ...
 */
        ...
        var core_helpers = function() {
            ...
            helpers$1.getAngleFromPoint = function(centrePoint, anglePoint) {
                ...
                var radialDistanceFromCenter = Math.sqrt(distanceFromXCenter * distanceFromXCenter +
 ...
 */
            ...
            return helpers$1.extend(helpers$1.options._parseFont({
                ...
                }),
                {
                    color: helpers$1.options.resolve([
                        nestedOpts.fontColor, options.fontColor, core_defaults.global.defaultFontColor
                    ])
                });
        }
        ...
        var Scale = core_element.extend({
            ...
            */
            ...
            update: function(maxWidth, maxHeight, margins) {
                ...
                // Auto-skip
                me._ticksToDraw = tickOpts.display && (tickOpts.autoSkip || tickOpts.source === 'auto')
                    ? me._autoSkip(ticks)
                    : ticks;
        ...
        var scale_category = core_scale.extend({
            ...
            buildTicks: function() {
                ...
                me.ticks = (minIndex === 0 && maxIndex === labels.length - 1)
                    ? labels
        ...
        var scale_logarithmic = core_scale.extend({
            ...
            _configure: function() {
                ...
                if (start === 0) {
                    ...
                    offset = valueOrDefault$b(me.options.ticks.fontSize, core_defaults.global.defaultFontSize) /
                        me._length;
                }
 ...
 */
        ...
        var scale_radialLinear = scale_linearbase.extend({
            ...
            setReductions: function(largestPossibleRadius, furthestLimits, furthestAngles) {
                ...
                var radiusReductionBottom = -Math.max(furthestLimits.b - (me.height - me.paddingTop), 0) /
            ...
            _drawGrid: function() {
                ...
                if (angleLineOpts.display && lineWidth && lineColor) {
                    ...
                    if (ctx.setLineDash) {
                        ...
                        ctx.lineDashOffset =
                            resolve$4([angleLineOpts.borderDashOffset, gridLineOpts.borderDashOffset, 0.0]);
                    }
 ...
 */
        ...
        var defaultConfig$4 = {
            ...
            time: {
                parser:
                    false, // false == a pattern string from https://momentjs.com/docs/#/parsing/string-format/ or a custom callback that converts its argument to a moment
        ...
        var scale_time = core_scale.extend({
            ...
            buildTicks: function() {
                ...
                me._unit = timeOpts.unit ||
                (tickOpts.autoSkip
                    ? determineUnitForAutoTicks(timeOpts.minUnit, me.min, me.max, capacity)
                    : determineUnitForFormatting(me, ticks.length, timeOpts.minUnit, me.min, me.max));
                me._majorUnit = !tickOpts.major.enabled || me._unit === 'year'
                    ? undefined
            ...
            getLabelCapacity: function(exampleTime) {
                ...
                var exampleLabel = me.tickFormatFunction(exampleTime,
                    0,
            ...
            (function(global, factory) {
                ...
                (function() {
                        ...
                        for (i = 0; i < 12; i++) {
                            ...
                            if (strict && !this._longMonthsParse[i]) {
                                this._longMonthsParse[i] =
                                    new RegExp('^' + this.months(mom, '').replace('.', '') + '$', 'i');
                        ...
                        for (i = 0; i < 7; i++) {
                            ...
                            if (strict && !this._fullWeekdaysParse[i]) {
                                ...
                                this._minWeekdaysParse[i] =
                                    new RegExp('^' + this.weekdaysMin(mom, '').replace('.', '\\.?') + '$', 'i');
                            }
                    ...
                    function configFromRFC2822(config) {
                        ...
                        if (match) {
                            var parsedArray = extractFromRFC2822Strings(match[4],
                                match[3],
                                match[2],
                                match[5],
                                match[6],
 ...
 */
        var Title = core_element.extend({
            ...
            draw: function() {
                ...
                ctx.fillStyle =
                    helpers$1.valueOrDefault(opts.fontColor,
                        core_defaults.global.defaultFontColor); // render in correct colour
...
// Register built-in scales
        ...
        core_controller.helpers.each(scales,
            function(scale, type) {
