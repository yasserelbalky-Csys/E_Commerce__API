...
(function(global, factory) {
    ...
    (function() {
        ...
        const nativeEvents = new Set([
            'click', 'dblclick', 'mouseup', 'mousedown', 'contextmenu', 'mousewheel', 'DOMMouseScroll', 'mouseover',
            'mouseout', 'mousemove', 'selectstart', 'selectend', 'keydown', 'keypress', 'keyup', 'orientationchange',
            'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerdown', 'pointermove', 'pointerup',
            'pointerleave', 'pointercancel', 'gesturestart', 'gesturechange', 'gestureend', 'focus', 'blur', 'change',
        ...
        function addHandler(element, originalTypeEvent, handler, delegationFunction, oneOff) {
            ...
            let [isDelegated, callable, typeEvent] =
        ...
        const EventHandler = {
            ...
            off(element, originalTypeEvent, handler, delegationFunction) {
                ...
                const [isDelegated, callable, typeEvent] =
                    normalizeParameters(originalTypeEvent, handler, delegationFunction);
        ...
        const Manipulator = {
            ...
            getDataAttributes(element) {
                ...
                const attributes = {};
                const bsKeys = Object.keys(element.dataset)
                    .filter(key => key.startsWith('bs') && !key.startsWith('bsConfig'));
        ...
        class Config {
            ...
            _mergeConfigObj(config, element) {
                const jsonConfig =
                    isElement$1(element) ? Manipulator.getDataAttribute(element, 'config') : {}; // try to parse
            ...
            _typeCheckConfig(config, configTypes = this.constructor.DefaultType) {
                for (const [property, expectedTypes] of Object.entries(configTypes)) {
                    ...
                    if (!new RegExp(expectedTypes).test(valueType)) {
                        throw new TypeError(
                            `${this.constructor.NAME.toUpperCase()}: Option "${property}" provided type "${valueType
        ...
        class Carousel extends BaseComponent {
            ...
            _setActiveIndicatorElement(index) {
                ...
                const newActiveIndicator =
                    SelectorEngine.findOne(`[data-bs-slide-to="${index}"]`, this._indicatorsElement);
            ...
            _slide(order, element = null) {
                ...
                const triggerEvent = eventName => {
                    return EventHandler.trigger(this._element,
                        eventName,
                        {
        ...
        class Collapse extends BaseComponent {
            ...
            show() {
                ...
                if (this._config.parent) {
                    activeChildren = this._getFirstLevelChildren(SELECTOR_ACTIVES)
                        .filter(element => element !== this._element).map(element => Collapse.getOrCreateInstance(
                            element,
                            {
                                toggle: false
                            }));
            ...
            _getFirstLevelChildren(selector) {
                ...
                return SelectorEngine.find(selector, this._config.parent)
        ...
        function effect$2(_ref2) {
            ...
            return function() {
                Object.keys(state.elements).forEach(function(name) {
                    ...
                    var attributes = state.attributes[name] || {};
                    var styleProperties =
                        Object.keys(state.styles.hasOwnProperty(name)
                            ? state.styles[name]
        ...
        function arrow(_ref) {
            ...
            var clientSize = arrowOffsetParent
                ...
                : 0;
            var centerToReference =
                endDiff / 2 - startDiff / 2; // Make sure the arrow doesn't overflow the popper if the center point is
            ...
            var axisProp = axis;
            state.modifiersData[name] = (_state$modifiersData$ = {}, _state$modifiersData$[axisProp] =
                offset, _state$modifiersData$.centerOffset = offset - center, _state$modifiersData$);
        }
        ...
        function mapToStyles(_ref2) {
            ...
            if (gpuAcceleration) {
                ...
                return Object.assign({},
                    commonStyles,
                    (_Object$assign = {}, _Object$assign[sideY] = hasY ? '0' : '', _Object$assign[sideX] =
                        hasX ? '0' : '', _Object$assign.transform =
            ...
            return Object.assign({},
                commonStyles,
                (_Object$assign2 = {}, _Object$assign2[sideY] = hasY ? y + "px" : '', _Object$assign2[sideX] =
                    hasX ? x + "px" : '', _Object$assign2.transform = '', _Object$assign2));
        }
        ...
        function getDocumentRect(element) {
            ...
            var width = max(html.scrollWidth,
                html.clientWidth,
                body ? body.scrollWidth : 0,
                body ? body.clientWidth : 0);
            var height = max(html.scrollHeight,
                html.clientHeight,
        ...
        */
        ...
        function getExpandedFallbackPlacements(placement) {
            ...
            return [
                getOppositeVariationPlacement(placement), oppositePlacement,
        ...
        function preventOverflow(_ref) {
            ...
            if (checkMainAxis) {
                ...
                var offsetModifierValue =
                    (_offsetModifierState$ = offsetModifierState == null ? void 0 : offsetModifierState[mainAxis]) !=
                        null
            ...
            if (checkAltAxis) {
                ...
                var _offsetModifierValue =
                    (_offsetModifierState$2 = offsetModifierState == null ? void 0 : offsetModifierState[altAxis]) !=
                        null
            ...
            return function createPopper(reference, popper, options) {
                ...
                var instance = {
                    ...
                    forceUpdate: function forceUpdate() {
                        ...
                        state.rects = {
                            reference: getCompositeRect(reference,
        ...
        var defaultModifiers = [
            eventListeners, popperOffsets$1, computeStyles$1, applyStyles$1, offset$1, flip$1, preventOverflow$1,
            arrow$1, hide$1
        ];
        ...
        const Popper = /*#__PURE__*/Object.freeze(/*#__PURE__*/
        ...
        class ScrollBarHelper {
            ...
            hide() {
                ...
                this._setElementAttributes(SELECTOR_FIXED_CONTENT,
                    PROPERTY_PADDING,
                    calculatedValue => calculatedValue + width);
                this._setElementAttributes(SELECTOR_STICKY_CONTENT,
                    PROPERTY_MARGIN,
                    calculatedValue => calculatedValue - width);
            }
        ...
        class Modal extends BaseComponent {
            ...
            show(relatedTarget) {
                ...
                const showEvent = EventHandler.trigger(this._element,
                    EVENT_SHOW$4,
                    {
                        relatedTarget
                    });
            ...
            _addEventListeners() {
                ...
                EventHandler.on(this._element,
                    ...
                    event => {
                        ...
                        EventHandler.one(this._element,
                            EVENT_CLICK_DISMISS,
                            event2 => {
        ...
        class ScrollSpy extends BaseComponent {
            ...
            _maybeEnableSmoothScroll() {
                ...
                EventHandler.on(this._config.target,
                    EVENT_CLICK,
            ...
            _activateParents(target) {
                ...
                if (target.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
                    SelectorEngine.findOne(SELECTOR_DROPDOWN_TOGGLE$1, target.closest(SELECTOR_DROPDOWN)).classList
                        .add(CLASS_NAME_ACTIVE$1);
                    return;
                }
        ...
        const SELECTOR_INNER =
            `.nav-link${NOT_SELECTOR_DROPDOWN_TOGGLE}, .list-group-item${NOT_SELECTOR_DROPDOWN_TOGGLE}, [role="tab"]${
        ...
        const SELECTOR_DATA_TOGGLE_ACTIVE =
            `.${CLASS_NAME_ACTIVE}[data-bs-toggle="tab"], .${CLASS_NAME_ACTIVE}[data-bs-toggle="pill"], .${
                CLASS_NAME_ACTIVE}[data-bs-toggle="list"]`;
        ...
        class Tab extends BaseComponent {
            ...
            _activate(element, relatedElem) {
                ...
                this._activate(
                    SelectorEngine.getElementFromSelector(element)); // Search and activate/show the proper section
            ...
            _deactivate(element, relatedElem) {
                ...
                element.blur();
                this._deactivate(
                    SelectorEngine.getElementFromSelector(element)); // Search and deactivate the shown section too
            ...
            _keydown(event) {
                if (![ARROW_LEFT_KEY, ARROW_RIGHT_KEY, ARROW_UP_KEY, ARROW_DOWN_KEY, HOME_KEY, END_KEY]
                    .includes(event.key)) {
                    return;
                }
